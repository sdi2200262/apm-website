...
The Rules file lives outside `.apm/` - it's written to your platform's rules file (e.g. `CLAUDE.md`, `AGENTS.md`, `AGENTS.md`) so your assistant reads it automatically.
